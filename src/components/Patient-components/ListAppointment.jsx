...
export const ListAppointment = () => {
  ...
  return (
    <>
      <section
        id="List-Appointment"
        className="flex flex-col p-5 mb-16 rounded-2xl opacity-90 bg-[#dad4c4] bg-opacity-65 border border-slate-400"
      >
        <div className="flex items-center justify-center gap-4 p-2 m-4">
          <h2 className="font-semibold text-black">MIS CITAS</h2>
        </div>
        <table className="min-w-full overflow-hidden text-gray-300 bg-gray-800 rounded-md shadow-lg table-auto">
          <thead>
